...
However, as an approach it may be less useful for resolving some of the issues of multi-team and multi-model forecasts as it does not provide interpretability, key for stakeholder take-up. Additionally, it is not clear how the methods commonly used perform out of sample, and emulating a quantile based forecast is an unaddressed methodological challenge as far as we are aware.
...
We standardised the magnitude of observations and forecasts across forecast locations by scaling both weekly notified test positive cases and forecast test positive cases by the population in the forecast region to an incidence rate per 10,000 people.
...
Many countries, such as the UK, saw large BA.1 waves in January that then resulted in declining incidence rates through February (Figure \@ref(fig:vis-forecasts)).
