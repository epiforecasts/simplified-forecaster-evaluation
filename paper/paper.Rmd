...
\end{align*}
where the mean and variance of the negative binomial are defined as \[ \mathbb{E}[n] = \mu \ \ \
\text{ and } \ \ \ \text{Var}[n] = \mu + \frac{\mu^2}{\phi}. \]
