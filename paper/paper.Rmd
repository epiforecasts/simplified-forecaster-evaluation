...
`r relative_wis_thresholds[, better_than]` of surrogate forecasts scored better than the comparable ensemble forecast, `r relative_wis_thresholds[, fifty_percent]` performed within 50% of the comparable ensemble forecat, and `r relative_wis_thresholds[, more_than_100_percent]` scored performed worse than 100% more than the comparable ensemble forecast.
