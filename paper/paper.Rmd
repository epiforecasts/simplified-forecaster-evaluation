...
```
  ...
  The ensemble forecast was constructed by taking the median of all predictive quantiles without the exclusion of any valid submitted forecast (where validity was defined as passing minimal formatting checks by the hub team). 
...
Both the WIS and CRPS are generalisations of the absolute error in order to evaluate probabilistic forecasts and are widely used to evaluate COVID-19 forecasts, including by the ECDC forecast hub  [@REF].
...
In order to maintain the propriety of this score, we do this after first taking the means of scores for the relevant stratification.
