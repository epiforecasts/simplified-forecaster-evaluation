...
We model the expectation ($\lambda_t$) of reported cases ($C_t$) as an order 1 autoregressive (AR(1)) process by epidemiological week ($t$) on the log scale.
...
p <- (
  ...
  theme(
    ...
    legend.justification = "centre", axis.title = element_text(size = 12)
  )
