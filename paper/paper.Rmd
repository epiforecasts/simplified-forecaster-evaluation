...
Breaking down the relative weighted interval score by forecast interval we observe that the majority of the difference in overall scores is likely driven by differences in the outer intervals [b][c][d]and in particular the tails of the forecast (Figure \@ref(fig:plot-coverage) c).
