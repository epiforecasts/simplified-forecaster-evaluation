...
```{r plot-eval, fig.height = 12, fig.width = 18, out.width = "95%"}
 (
  (
    (
      plot_rel_wis(coverage, ranges) /
      plot_rel_wis_by_horizon(relative_wis)
    )  +
    plot_layout(heights = c(3, 1), guides = "collect")
  ) |
  plot_rel_wis_by_location(relative_wis)
) +
