...
In this study, we define the model outlined above and summarise its implementation, with a focus on minimal resource use and reproducibility, as a GitHub action. 
